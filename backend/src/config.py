...
# Project Root (calculated relative to this file which is in backend/src)
PROJECT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../'))

# Output Paths
PATHS = {
    'data_dir': os.path.join(PROJECT_ROOT, 'data'),
    'models_dir': os.path.join(PROJECT_ROOT, 'backend/src/models'), # Keep models in src/models or root? Let's use src/models as source of truth for code, but maybe root for saving? I'll use src/models
